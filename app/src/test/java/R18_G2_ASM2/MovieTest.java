...
public class MovieTest {
  ...
  @BeforeAll static void setupTestData() {
    ...
    movies.put(4, new Movie(4,"Mov 4",cast2,Classification.G,dir1,"synop 4",releaseDate.get(3)));
    movies.put(5, new Movie(5,"Mov 5",cast2,Classification.G,dir1,"synop 5",releaseDate.get(4)));
    movies.put(6, new Movie(6,"Mov 6",cast2,Classification.G,dir1,"synop 6",releaseDate.get(5)));
